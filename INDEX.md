...
│   └─ 完整统计、阅读路径、使用说明
│   └─ Complete statistics, reading path, usage notes
│
├── 📂 src/                                   # 技术介绍代码骨架 / Technical introduction code skeleton
│   │
│   ├── 📂 core/                              # 核心层 / Core layer
...
### 💻 了解代码实现 / Understand Code Implementation

**如果你想了解代码实现 / If you want to understand code implementation:**
