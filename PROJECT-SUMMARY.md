...
**中文**: 
本项目成功将 GH Helper（小壁蜂OsmiaAI） Super 的完整技术架构整理为结构化的文档和代码骨架，所有界面交互和后端API都做了抽象化处理，适合技术学习和架构参考，而非直接使用。

**在线体验 / Live Demo**: https://topogenesis.top/intro/ghhelper

**English**:
This project successfully organized the complete technical architecture of GH Helper (OsmiaAI) Super into structured documentation and code skeleton. All UI interactions and backend APIs have been abstracted, making it suitable for technical learning and architecture reference rather than direct use.
...
### 三、技术学习代码骨架 / Technical Learning Code Skeleton

#### 核心层 / Core Layer

| 文件名 / Filename | 行数 / Lines | 说明 / Description |
|------------------|-------------|-------------------|
| src/core/event-bus.js | 241 | EventBus 实现，含详细学习注释 |
...
3. 学习 src/core/event-bus.js 掌握事件总线

### 中级 / Intermediate
1. 阅读 MODULES.md 深入模块设计
2. 学习 src/core/state-store.js 理解状态管理
3. 学习 src/agents/agent-base.js 掌握模板方法模式

### 高级 / Advanced
1. 阅读 Architecture-Whitepaper-CN-EN.md 理解架构原理
2. 阅读 API-REFERENCE.md 了解接口设计
3. 阅读 EXTENSION-GUIDE.md 学习扩展开发
...
**中文**:
本架构整理项目的目的是**技术学习和架构参考**，而非直接可用的完整系统。

- ✅ 适合：学习设计模式、理解架构设计、参考代码实现
- ❌ 不适合：直接部署使用、复制代码运行
...
**English**:
The purpose of this architecture organization project is **technical learning and architecture reference**, not a complete ready-to-use system.

- ✅ Suitable for: Learning design patterns, understanding architecture design, referencing code implementation
